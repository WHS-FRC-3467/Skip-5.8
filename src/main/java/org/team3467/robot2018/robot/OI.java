...
public class OI {
	...
	public void BindCommands() {
		...
		new ButtonBoxButton(bBox, ButtonBox.Button.k3).whenPressed(new ArmLiftTransition(ArmLift.eArmLiftState.OnFloor, false));
		new ButtonBoxButton(bBox, ButtonBox.Button.k4).whenPressed(new ArmLiftTransition(ArmLift.eArmLiftState.OnStep, false));
		new ButtonBoxButton(bBox, ButtonBox.Button.k2).whenPressed(new ArmLiftTransition(ArmLift.eArmLiftState.Level2Cube, false));
		new ButtonBoxButton(bBox, ButtonBox.Button.k1).whenPressed(new ArmLiftTransition(ArmLift.eArmLiftState.SwitchFront, false));
		new ButtonBoxButton(bBox, ButtonBox.Button.k5).whenPressed(new ArmLiftTransition(ArmLift.eArmLiftState.HighLow, false));
		new ButtonBoxButton(bBox, ButtonBox.Button.k6).whenPressed(new ArmLiftTransition(ArmLift.eArmLiftState.ScaleHigh, false));
		new ButtonBoxButton(bBox, ButtonBox.Button.k8).whenPressed(new ArmLiftTransition(ArmLift.eArmLiftState.ScaleLow, false));
		new ButtonBoxButton(bBox, ButtonBox.Button.k9).whenPressed(new ArmLiftTransition(ArmLift.eArmLiftState.SwitchBack, false));
		new ButtonBoxButton(bBox, ButtonBox.Button.k7).whenPressed(new ArmLiftTransition(ArmLift.eArmLiftState.OnTrunk, false));
		...
		//new ButtonBoxButton(bBox, ButtonBox.Button.k11).whenPressed(new ArmLiftTransition(ArmLift.eArmLiftState.OnFloor, false));
		...
		SmartDashboard.putData("Move to Floor", new ArmLiftTransition(ArmLift.eArmLiftState.OnFloor, false));
		SmartDashboard.putData("Move to Step", new ArmLiftTransition(ArmLift.eArmLiftState.OnStep, false));
		SmartDashboard.putData("Move to 2nd Lvl Cube", new ArmLiftTransition(ArmLift.eArmLiftState.Level2Cube, false));
		SmartDashboard.putData("Move to Front Switch", new ArmLiftTransition(ArmLift.eArmLiftState.SwitchFront, false));
		SmartDashboard.putData("Move to High", new ArmLiftTransition(ArmLift.eArmLiftState.HighLow, false));
		SmartDashboard.putData("Move to Scale High", new ArmLiftTransition(ArmLift.eArmLiftState.ScaleHigh, false));
		SmartDashboard.putData("Move to Scale Low", new ArmLiftTransition(ArmLift.eArmLiftState.ScaleLow, false));
		SmartDashboard.putData("Move to Back Switch", new ArmLiftTransition(ArmLift.eArmLiftState.SwitchBack, false));
		SmartDashboard.putData("Move to Trunk", new ArmLiftTransition(ArmLift.eArmLiftState.OnTrunk, false));
